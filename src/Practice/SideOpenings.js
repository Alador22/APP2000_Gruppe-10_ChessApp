...
const openings = [
  ...
  {
    name: "French Defense",
    moves: ["e2e4", "e7e6", "d2d4", "d7d5", "e4d5", "c8d7"],
  },
  {
    name: "London System",
    moves: ["d2d4", "d7d5", "g2g3", "e7e6", "f1g2", "b8c6"],
  },
  {
    name: "Spanish Game",
  ...
  },
  {
    ...
    moves: ["e2e4", "c7c6", "d2d4", "d7d5", "e4d5", "c6d5"],
  },
];
...
const SideOpenings = ({ chess, setPosition, addMoveToList, showOpenings }) => {
  ...
  return (
    <ul
      className="openings-container"
      style={{ display: showOpenings ? "block" : "none" }}
    >
